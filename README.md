...
This repository contains Altium PCB files for UBC Thunderbots' estop pcb. Anyone who wishes to push changes to this project must get permission from the current Electrical Team Lead.
...
2. **Recursively clone** (`git clone --recurse-submodules`) your working branch of the repository to your PC (i.e. `C:/Documents/thunderbots/PCB_EStop`).
...
---|---
Name|PCB_EStop
Default Checkout Path|location of local repository (i.e. `C:/Documents/thunderbots/PCB_EStop`)
Method|https
Server|github.com
Server Port|Default
...
`estop-v1.0/`), `archive/`, and `Altium_Libraries/`. Any previous versions should be placed in `archive/`. Every board revision directory should abide by the following structure:
